import { Image, Properties as CarouselProperties } from './interfaces';
...
export class Cells {
    ...
    getCellIndexInContainer(cellIndexInDOMTree: number): number {
        let positionIndex;
    ...
    getImageIndex(cellIndexInDOMTree: number): number {
        const positionIndex = this.getCellIndexInContainer(cellIndexInDOMTree);
        let imageIndex;
