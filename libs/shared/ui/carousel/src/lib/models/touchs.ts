...
export class Touches {
    ...
    handleWheel = (event: any): any => {
        this.runHandler('wheel', event);
    };

    /* Resize */

    handleResize = (event: any): any => {
    ...
    detectDoubleTap(): boolean | undefined {
        if (this.eventType !== undefined) {
            return;
        }
    ...
    detectLinearSwipe(event: any): string | undefined {
        const touches = event.touches;
