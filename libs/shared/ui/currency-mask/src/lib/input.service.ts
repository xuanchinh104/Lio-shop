...
export class InputService {
    ...
    constructor(private htmlInputElement: SafeAny, private options: SafeAny) {
        this.inputManager = new InputManager(htmlInputElement);
    }

    addNumber(keyCode: number | null): void {
        if (!this.rawValue) {
    ...
    fixCursorPosition(forceToEndPosition?: boolean): void {
        ...
        // it is moved to the end of the number, ignoring the prefix or suffix. this behavior can be forced with forceToEndPosition flag
    ...
    get value(): number {
        return <number>this.clearMask(this.rawValue);
    }
