...
(function () {
    ...
    q.lists = {
        ...
        setListSymbol: function (c, b, d) {
            ...
            } else (f = { '·': 'disc', o: 'circle', '§': 'square' }), !e['list-style-type'] && f[b] && (e['list-style-type'] = f[b]);
        ...
        calculateValue: function (c) {
            ...
            for (g = c; 0 <= g && null === d; g--)
                (f = b.children[g]), f.attributes && void 0 !== f.attributes.value && ((e = g), (d = parseInt(f.attributes.value, 10)));
