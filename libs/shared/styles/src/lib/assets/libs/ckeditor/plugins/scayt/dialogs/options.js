    ...
    d.on('scaytUserDictionaryAction', function (b) {
        ...
        void 0 === b.data.error
            ...
            : ('' === b.data.name
                  ...
                  : ((c = e.getLocal('message_error_' + b.data.command + 'Dic')), (c = c.replace('%s', b.data.name)), d.setText(c)),
              a.css(d.$, { color: 'red' }),
...
CKEDITOR.ui.dialog.scaytItemList.prototype = CKEDITOR.tools.extend(new CKEDITOR.ui.dialog.uiElement(), {
    ...
    inChildren: function (d) {
        return SCAYT.prototype.SharedUtils.inArray(this.children, d);
    },
    removeChild: function (d, c) {
        this.children.splice(SCAYT.prototype.SharedUtils.indexOf(this.children, c), 1);
