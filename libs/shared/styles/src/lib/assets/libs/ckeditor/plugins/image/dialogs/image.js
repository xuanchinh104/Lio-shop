        ...
        return {
            ...
            getModel: function (editor) {
                var element = editor.getSelection().getSelectedElement(),
                    ...
                    isImageInput = element && element.getName() === 'input' && element.getAttribute('type') === 'image';
            ...
            onOk: function () {
                ...
                // Create a new image.
                    ...
                    if (dialogType == 'image') this.imageElement = editor.document.createElement('img');
                    else {
                        this.imageElement = editor.document.createElement('input');
                                                            ...
                                                            ratioButton.on(
                                                                ...
                                                                function (evt) {
                                                                    ...
                                                                    if (oImageOriginal.getCustomData('isReady') == 'true' && width) {
                                                                        var height =
                                                                            (oImageOriginal.$.height / oImageOriginal.$.width) * width;
                                                                        if (!isNaN(height)) {
