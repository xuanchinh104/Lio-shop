...
(function () {
    function k(b, c) {
        if (!(b.previous && g(b.previous) && b.getFirst().children.length && 1 === b.children.length && g(b.getFirst().getFirst())))
            return !1;
                ...
                elements: {
                    ...
                    font: function (a) {
                        ...
                        c['font-size'] &&
                            ...
                            (a.name = 'span'),
                            b && b.type === CKEDITOR.NODE_ELEMENT && b.attributes.size && b.replaceWithChildren());
                    },
                    ul: function (a) {
                        if (k(a, d)) return !1;
                    },
