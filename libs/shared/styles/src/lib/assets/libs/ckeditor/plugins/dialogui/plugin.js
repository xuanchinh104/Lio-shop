    ...
    onLoad: function () {
        var initPrivateObject = function (elementDefinition) {
            ...
            toggleBidiKeyUpHandler = function (evt) {
                ...
                if (keystroke == CKEDITOR.SHIFT + CKEDITOR.ALT + 36) this.setDirectionMarker('ltr');
                // ALT + SHIFT + End for RTL direction.
                else if (keystroke == CKEDITOR.SHIFT + CKEDITOR.ALT + 35) this.setDirectionMarker('rtl');
            };
        ...
        CKEDITOR.tools.extend(
            CKEDITOR.ui.dialog,
            {
                ...
                labeledElement: function (dialog, elementDefinition, htmlList, contentHtml) {
                    ...
                    if (elementDefinition.includeLabel) attributes['aria-labelledby'] = _.labelId;
                ...
                radio: function (dialog, elementDefinition, htmlList) {
                    ...
                    var innerHTML = function () {
                        ...
                        for (var i = 0; i < elementDefinition.items.length; i++) {
                            ...
                            children.push(
                                new CKEDITOR.ui.dialog.uiElement(dialog, inputDefinition, inputHtml, 'input', null, inputAttributes)
                            );
                ...
                fieldset: function (dialog, childObjList, childHtmlList, htmlList, elementDefinition) {
                    ...
                    var innerHTML = function () {
                        ...
                        for (var i = 0; i < childHtmlList.length; i++) html.push(childHtmlList[i]);
                        return html.join('');
                    };
        ...
        CKEDITOR.ui.dialog.checkbox.prototype = CKEDITOR.tools.extend(
            new CKEDITOR.ui.dialog.uiElement(),
            {
                ...
                eventProcessors: {
                    onChange: function (dialog, func) {
                        if (!CKEDITOR.env.ie || CKEDITOR.env.version > 8) return commonEventProcessors.onChange.apply(this, arguments);
                        else {
                            dialog.on(
                                'load',
                                function () {
            ...
            new CKEDITOR.ui.dialog.uiElement(),
            {
                ...
                getValue: function () {
                    ...
                    for (var i = 0; i < children.length; i++) {
                        if (children[i].getElement().$.checked) return children[i].getValue();
                    }
                    return null;
                },
            ...
            commonPrototype,
            {
                ...
                reset: function () {
                    ...
                    function generateFormField() {
                        ...
                        var size = '';
                        if (elementDefinition.size) size = elementDefinition.size - (CKEDITOR.env.ie ? 7 : 0); // "Browse" button is bigger in IE.
